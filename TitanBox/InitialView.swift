...
//                                NavigationLink {
//                                    //                        Text("Box at \(box.timestamp!, formatter: boxFormatter)")
//                                    VStack {
//                                        Text("Box created at \(box.timestamp ?? Date())")
//                                        Text("With name \(box.name ?? "(Unknown box)")")
//                                        Text("and ID \(box.id?.uuidString ?? "")")
//                                    }
//                                } label: {
